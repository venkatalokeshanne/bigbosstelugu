export default function SitemapSection() {
  const sitemapLinks = [
    // Main Pages
    { href: '/', title: 'Bigg Boss Telugu 10 Voting Home', description: 'Main voting platform for BB Telugu 10' },
    { href: '/contestants', title: 'All Contestants List', description: 'Complete list of BB Telugu 10 contestants with profiles' },
    ...
    // Voting Methods
    { href: '/hotstar-voting', title: 'Hotstar Voting Guide', description: 'Complete guide for voting through JioHotstar app' },
    ...
    { href: '/host-nagarjuna', title: 'Host Akkineni Nagarjuna', description: 'About the host of Bigg Boss Telugu 10' },
    { href: '/house-tour', title: 'Bigg Boss House Tour', description: 'Inside look at the BB Telugu 10 house' },
    { href: '/rules-format', title: 'Game Rules & Format', description: 'BB Telugu 10 game rules and format explained' },
    ...
    // Contestant Profiles
    { href: '/contestant-biographies', title: 'Contestant Biographies', description: 'Detailed profiles of all BB Telugu 10 contestants' },
    ...
    // Live Updates
    { href: '/live-updates', title: 'Live Updates Feed', description: 'Real-time updates from BB Telugu 10 house' },
    ...
    // Special Features
    { href: '/mobile-app', title: 'Mobile App Download', description: 'Download BB Telugu 10 voting mobile app' },
    ...
    <section className="py-16 bg-gray-900/50">
      <div className="container-custom">
        ...
        <div className="sr-only">
          <h2>Bigg Boss Telugu 10 Complete Site Map</h2>
          <p>Navigate through all sections of our comprehensive BB Telugu 10 voting platform</p>
          ...
          <div>
            ...
            <p>
              bigg boss telugu 10 voting online, bb telugu 10 vote today, bigg boss telugu season 9 contestants list, 
              star maa bigg boss telugu vote, hotstar bb telugu voting, bigg boss telugu 10 elimination this week, 
              nagarjuna bigg boss telugu host, bb telugu 10 missed call voting numbers, bigg boss telugu live streaming, 
              bb telugu 10 winner prediction, bigg boss telugu voting results today, star maa tv show timings, 
              disney plus hotstar bigg boss telugu, bb telugu 10 nominations list, bigg boss telugu house location, 
              bb telugu voting from usa, international bigg boss telugu voting, bb telugu 10 episode highlights, 
              bigg boss telugu social media updates, bb telugu 10 captaincy task, bigg boss telugu finale date, 
              bb telugu 10 prize money, bigg boss telugu previous seasons, bb telugu voting tips and tricks
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              hyderabad bigg boss telugu voting, telangana bb telugu 10, andhra pradesh bigg boss voting, 
