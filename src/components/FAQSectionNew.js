...
export default function FAQSection() {
  ...
  const defaultFAQs = [
    ...
    },
    {
      ...
      answer: 'You can vote for BB Telugu 10 through: 1) JioHotstar app (up to 10 votes per day), 2) Bigg Boss Telugu 10 missed call numbers (50 votes per week), 3) Google voting polls (unofficial), 4) SMS voting when available for BB Telugu 10.'
    },
    {
      _id: 'default-11',
